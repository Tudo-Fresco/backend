...
class PostResponseModel(BaseResponseModel):
    ...
    deadline: Optional[datetime] = Field(..., example='2025-10-01T12:00:00')
    status: Optional[DemandStatus] = Field(..., example=DemandStatus.OPENED.value)
    minimum_count: Optional[int] = Field(..., example=777)